async function deleteData() {
    ...
    try {
        ...
        // Re-route this to 'http://10.0.2.5:8000/unsecure-api/eraseDataPortal?e=' when deploying to linux
        const response = await fetch('http://10.0.2.5:8000/unsecure-api/eraseDataPortal?e=' + email + "&p=" + password,
        { method: 'get'});
