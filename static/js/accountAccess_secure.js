async function LogIn() {
    ...
    try {
        ...
        const response = await fetch('http://10.0.2.5:9000/secure-api/accountAccessPortal?e=' + encodeURIComponent(encryptedEmail) + '&p=' + encodeURIComponent(encryptedPassword) + '&iv=' + encodeURIComponent(iv.toString(CryptoJS.enc.Base64)), {
            method: 'GET',
            headers: {
